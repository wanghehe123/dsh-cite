...
export const zh = {
  ...
  'menu.revealWorkspace.macos': '在 Finder 中显示',
  'menu.revealWorkspace.windows': '在资源管理器中显示',
  'menu.revealWorkspace.linux': '在文件管理器中显示',
  'copy.success': '会话 ID 已复制',
...
export const en = {
  ...
  'menu.revealWorkspace.macos': 'Reveal in Finder',
  'menu.revealWorkspace.windows': 'Show in Explorer',
  'menu.revealWorkspace.linux': 'Show in file manager',
  'copy.success': 'Session ID copied',
  'copy.failure': 'Copy failed, please retry',
